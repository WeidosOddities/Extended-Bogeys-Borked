...
public class WalschaertsBogeyRenderer {
    public static class LargeDoubleAxleShortWalschaertsBogeyRenderer extends BogeyRenderer {
        @Override
        public void initialiseContraptionModelData(MaterialManager materialManager, CarriageBogey carriageBogey) {
            createModelInstance(materialManager, L_A4S_WALSCHAERTS_FRAME);
            ...
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_C_LEVER);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_C_ROD);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_E_LINK);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_E_ROD);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_M_ROD);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_P_ROD);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_R_BAR);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_U_LINK);
            createModelInstance(materialManager, L_R4S_WALSCHAERTS_V_STEM);

            createModelInstance(materialManager, L_L4S_WALSCHAERTS_C_LEVER);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_C_ROD);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_E_LINK);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_E_ROD);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_M_ROD);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_P_ROD);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_R_BAR);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_U_LINK);
            createModelInstance(materialManager, L_L4S_WALSCHAERTS_V_STEM);
        ...
        public void render(CompoundTag bogeyData, float wheelAngle, PoseStack ms, int light, VertexConsumer vb, boolean inContraption) {
            ...
            double y_height = 1;
            double z_offset = 0.875;
            double offset_piston = 1.5625+0.015625;
            double offset_union_link = 0.015625*2;
            double wheel_spacing = 0.875;

            double radius_crank = 0.25;
            double radius_eccentric = 0.1875;
            double length_combination_lever = 1;
            double length_main_rod = 1.5625;
            double length_eccentric_rod = 0.9375;
            double length_union_link = 0.375;
            double offset_y_union_link = 0.375;
            double length_expansion_link = 0.5625;
            double length_radius_bar = 1.0625;
            double rotation_radius_bar = 13;
            double offset_valve_stem = 1.1125;
            ...
            getTransform(L_A4S_WALSCHAERTS_FRAME, ms, inInstancedContraption)
                    .render(ms, light, vb);
            ...
            getTransform(L_R4S_WALSCHAERTS_C_ROD, ms, inInstancedContraption)
            ...
            getTransform(L_R4S_WALSCHAERTS_P_ROD, ms, inInstancedContraption)
                    .translateZ(r_piston_stroke - offset_piston)
                    .render(ms, light, vb);

            getTransform(L_R4S_WALSCHAERTS_M_ROD, ms, inInstancedContraption)
                    .translateY(y_height)
                    .translateZ(r_m_rod_z - length_main_rod + z_offset)
                    .rotateX(r_m_rod_rotate)
                    .render(ms, light, vb);

            getTransform(L_R4S_WALSCHAERTS_E_ROD, ms, inInstancedContraption)
                    .translateZ(r_e_rod_z - length_eccentric_rod + z_offset)
                    .translateY(y_height + r_e_rod_y)
                    .rotateX(r_e_rod_rotate)
                    .render(ms, light, vb);

            getTransform(L_R4S_WALSCHAERTS_E_LINK, ms, inInstancedContraption)
                    .translateY(y_height + length_expansion_link)
                    .translateZ(-length_eccentric_rod + z_offset)
                    .rotateX(r_e_link_rotate)
                    .render(ms, light, vb);

            getTransform(L_R4S_WALSCHAERTS_U_LINK, ms, inInstancedContraption)
                    .translateY(y_height - offset_y_union_link)
                    .translateZ(-offset_piston + r_piston_stroke - offset_piston + z_offset + offset_union_link)
                    .rotateX(r_unionAngle)
                    .render(ms, light, vb);

            getTransform(L_R4S_WALSCHAERTS_R_BAR, ms, inInstancedContraption)
                    .translateY(y_height + r_r_bar_y)
                    .translateZ(-length_eccentric_rod + r_r_bar_z + z_offset)
                    .rotateX(rotation_radius_bar)
                    .render(ms, light, vb);

            getTransform(L_R4S_WALSCHAERTS_V_STEM, ms, inInstancedContraption)
                    .translateZ(r_v_stem_z - offset_valve_stem + z_offset)
                    .render(ms, light, vb);

            getTransform(L_R4S_WALSCHAERTS_C_LEVER, ms, inInstancedContraption)
                    .translateZ(-length_eccentric_rod - radius_bar_x + r_c_lever_z + z_offset)
                    .translateY(y_height + r_c_lever_y)
                    .rotateX(r_combAngle)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_C_ROD, ms, inInstancedContraption)
            ...
            getTransform(L_L4S_WALSCHAERTS_P_ROD, ms, inInstancedContraption)
                    .translateZ(l_piston_stroke - offset_piston)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_M_ROD, ms, inInstancedContraption)
                    .translateY(y_height)
                    .translateZ(l_m_rod_z - length_main_rod + z_offset)
                    .rotateX(l_m_rod_rotate)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_E_ROD, ms, inInstancedContraption)
                    .translateZ(l_e_rod_z - length_eccentric_rod + z_offset)
                    .translateY(y_height + l_e_rod_y)
                    .rotateX(l_e_rod_rotate)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_E_LINK, ms, inInstancedContraption)
                    .translateY(y_height + length_expansion_link)
                    .translateZ(-length_eccentric_rod + z_offset)
                    .rotateX(l_e_link_rotate)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_U_LINK, ms, inInstancedContraption)
                    .translateY(y_height - offset_y_union_link)
                    .translateZ(-offset_piston + l_piston_stroke - offset_piston + z_offset + offset_union_link)
                    .rotateX(l_unionAngle)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_R_BAR, ms, inInstancedContraption)
                    .translateY(y_height + l_r_bar_y)
                    .translateZ(-length_eccentric_rod + l_r_bar_z + z_offset)
                    .rotateX(rotation_radius_bar)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_V_STEM, ms, inInstancedContraption)
                    .translateZ(l_v_stem_z - offset_valve_stem + z_offset)
                    .render(ms, light, vb);

            getTransform(L_L4S_WALSCHAERTS_C_LEVER, ms, inInstancedContraption)
    ...
    public static class ExtraLargeTripleAxleShortWalschaertsBogeyRenderer extends BogeyRenderer {
        ...
        public void render(CompoundTag bogeyData, float wheelAngle, PoseStack ms, int light, VertexConsumer vb, boolean inContraption) {
            ...
            getTransform(XL_R6S_WALSCHAERTS_U_LINK, ms, inInstancedContraption)
                    .translateY(y_height - offset_y_union_link)
                    .translateZ(-offset_piston + r_piston_stroke - offset_piston + z_offset + 0.0208)
                    .rotateX(r_unionAngle)
                    .render(ms, light, vb);
            ...
            getTransform(XL_L6S_WALSCHAERTS_U_LINK, ms, inInstancedContraption)
                    .translateY(y_height - offset_y_union_link)
                    .translateZ(-offset_piston + l_piston_stroke - offset_piston + z_offset + 0.0208)
                    .rotateX(l_unionAngle)
                    .render(ms, light, vb);
