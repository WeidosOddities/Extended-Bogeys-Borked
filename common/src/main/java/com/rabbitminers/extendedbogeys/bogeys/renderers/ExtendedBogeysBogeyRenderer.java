...
public abstract class ExtendedBogeysBogeyRenderer extends BogeyRenderer {
    ...
    public abstract void render(boolean forwards, float wheelAngle, PoseStack ms, int light,
    ...
    public void render(CompoundTag bogeyData, float wheelAngle, PoseStack ms, int light, VertexConsumer vb,
        ...
        this.render(this.isForwards(bogeyData, inContraption), wheelAngle, ms, light, vb, inContraption);
    }
