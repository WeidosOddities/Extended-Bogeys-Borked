...
//Walschaerts
    L_WALSCHAERTS_WHEEL_CENTER = block("bogey/large/walschaerts/wheel_center"),
    ...
    L_R6S_WALSCHAERTS_C_ROD = block("bogey/large/walschaerts/l6_short/right_c_rod"),
    L_R6S_WALSCHAERTS_E_LINK = block("bogey/large/walschaerts/l6_short/right_e_link"),
    L_R6S_WALSCHAERTS_E_ROD = block("bogey/large/walschaerts/l6_short/right_e_rod"),
    L_R6S_WALSCHAERTS_M_ROD = block("bogey/large/walschaerts/l6_short/right_m_rod"),
    L_R6S_WALSCHAERTS_P_ROD = block("bogey/large/walschaerts/l6_short/right_p_rod"),
    L_R6S_WALSCHAERTS_R_BAR = block("bogey/large/walschaerts/l6_short/right_r_bar"),
    L_R6S_WALSCHAERTS_U_LINK = block("bogey/large/walschaerts/l6_short/right_u_link"),
    L_R6S_WALSCHAERTS_V_STEM = block("bogey/large/walschaerts/l6_short/right_v_stem"),

    L_L6S_WALSCHAERTS_C_LEVER = block("bogey/large/walschaerts/l6_short/left_c_lever"),
    L_L6S_WALSCHAERTS_C_ROD = block("bogey/large/walschaerts/l6_short/left_c_rod"),
    L_L6S_WALSCHAERTS_E_LINK = block("bogey/large/walschaerts/l6_short/left_e_link"),
    L_L6S_WALSCHAERTS_E_ROD = block("bogey/large/walschaerts/l6_short/left_e_rod"),
    L_L6S_WALSCHAERTS_M_ROD = block("bogey/large/walschaerts/l6_short/left_m_rod"),
    L_L6S_WALSCHAERTS_P_ROD = block("bogey/large/walschaerts/l6_short/left_p_rod"),
    L_L6S_WALSCHAERTS_R_BAR = block("bogey/large/walschaerts/l6_short/left_r_bar"),
    L_L6S_WALSCHAERTS_U_LINK = block("bogey/large/walschaerts/l6_short/left_u_link"),
    L_L6S_WALSCHAERTS_V_STEM = block("bogey/large/walschaerts/l6_short/left_v_stem"),

    XL_WALSCHAERTS_WHEEL_CENTER = block("bogey/extra_large/walschaerts/wheel_center"),
    XL_WALSCHAERTS_WHEEL_OUTER = block("bogey/extra_large/walschaerts/wheel_outer"),
    XL_WALSCHAERTS_ECCENTRIC = block("bogey/extra_large/walschaerts/eccentric"),

    XL_A6L_WALSCHAERTS_FRAME = block("bogey/extra_large/walschaerts/xl_long/frame"),

    XL_R6L_WALSCHAERTS_C_LEVER = block("bogey/extra_large/walschaerts/xl_long/right_c_lever"),
    XL_R6L_WALSCHAERTS_C_ROD = block("bogey/extra_large/walschaerts/xl_long/right_c_rod"),
    XL_R6L_WALSCHAERTS_E_LINK = block("bogey/extra_large/walschaerts/xl_long/right_e_link"),
    XL_R6L_WALSCHAERTS_E_ROD = block("bogey/extra_large/walschaerts/xl_long/right_e_rod"),
    XL_R6L_WALSCHAERTS_M_ROD = block("bogey/extra_large/walschaerts/xl_long/right_m_rod"),
    XL_R6L_WALSCHAERTS_P_ROD = block("bogey/extra_large/walschaerts/xl_long/right_p_rod"),
    XL_R6L_WALSCHAERTS_R_BAR = block("bogey/extra_large/walschaerts/xl_long/right_r_bar"),
    XL_R6L_WALSCHAERTS_U_LINK = block("bogey/extra_large/walschaerts/xl_long/right_u_link"),
    XL_R6L_WALSCHAERTS_V_STEM = block("bogey/extra_large/walschaerts/xl_long/right_v_stem"),

    XL_L6L_WALSCHAERTS_C_LEVER = block("bogey/extra_large/walschaerts/xl_long/left_c_lever"),
    XL_L6L_WALSCHAERTS_C_ROD = block("bogey/extra_large/walschaerts/xl_long/left_c_rod"),
    XL_L6L_WALSCHAERTS_E_LINK = block("bogey/extra_large/walschaerts/xl_long/left_e_link"),
    XL_L6L_WALSCHAERTS_E_ROD = block("bogey/extra_large/walschaerts/xl_long/left_e_rod"),
    XL_L6L_WALSCHAERTS_M_ROD = block("bogey/extra_large/walschaerts/xl_long/left_m_rod"),
    XL_L6L_WALSCHAERTS_P_ROD = block("bogey/extra_large/walschaerts/xl_long/left_p_rod"),
    XL_L6L_WALSCHAERTS_R_BAR = block("bogey/extra_large/walschaerts/xl_long/left_r_bar"),
    XL_L6L_WALSCHAERTS_U_LINK = block("bogey/extra_large/walschaerts/xl_long/left_u_link"),
    XL_L6L_WALSCHAERTS_V_STEM = block("bogey/extra_large/walschaerts/xl_long/left_v_stem"),
//Short
    XL_A6S_WALSCHAERTS_FRAME = block("bogey/extra_large/walschaerts/xl_short/frame"),

    XL_R6S_WALSCHAERTS_C_LEVER = block("bogey/extra_large/walschaerts/xl_short/right_c_lever"),
    XL_R6S_WALSCHAERTS_C_ROD = block("bogey/extra_large/walschaerts/xl_short/right_c_rod"),
    XL_R6S_WALSCHAERTS_E_LINK = block("bogey/extra_large/walschaerts/xl_short/right_e_link"),
    XL_R6S_WALSCHAERTS_E_ROD = block("bogey/extra_large/walschaerts/xl_short/right_e_rod"),
    XL_R6S_WALSCHAERTS_M_ROD = block("bogey/extra_large/walschaerts/xl_short/right_m_rod"),
    XL_R6S_WALSCHAERTS_P_ROD = block("bogey/extra_large/walschaerts/xl_short/right_p_rod"),
    XL_R6S_WALSCHAERTS_R_BAR = block("bogey/extra_large/walschaerts/xl_short/right_r_bar"),
    XL_R6S_WALSCHAERTS_U_LINK = block("bogey/extra_large/walschaerts/xl_short/right_u_link"),
    XL_R6S_WALSCHAERTS_V_STEM = block("bogey/extra_large/walschaerts/xl_short/right_v_stem"),

    XL_L6S_WALSCHAERTS_C_LEVER = block("bogey/extra_large/walschaerts/xl_short/left_c_lever"),
    XL_L6S_WALSCHAERTS_C_ROD = block("bogey/extra_large/walschaerts/xl_short/left_c_rod"),
    XL_L6S_WALSCHAERTS_E_LINK = block("bogey/extra_large/walschaerts/xl_short/left_e_link"),
    XL_L6S_WALSCHAERTS_E_ROD = block("bogey/extra_large/walschaerts/xl_short/left_e_rod"),
    XL_L6S_WALSCHAERTS_M_ROD = block("bogey/extra_large/walschaerts/xl_short/left_m_rod"),
    XL_L6S_WALSCHAERTS_P_ROD = block("bogey/extra_large/walschaerts/xl_short/left_p_rod"),
    XL_L6S_WALSCHAERTS_R_BAR = block("bogey/extra_large/walschaerts/xl_short/left_r_bar"),
    XL_L6S_WALSCHAERTS_U_LINK = block("bogey/extra_large/walschaerts/xl_short/left_u_link"),
    XL_L6S_WALSCHAERTS_V_STEM = block("bogey/extra_large/walschaerts/xl_short/left_v_stem"),

    XL_A8S_WALSCHAERTS_FRAME = block("bogey/extra_large/walschaerts/xl8_short/frame"),

    XL_R8S_WALSCHAERTS_C_LEVER = block("bogey/extra_large/walschaerts/xl8_short/right_c_lever"),
    XL_R8S_WALSCHAERTS_C_ROD = block("bogey/extra_large/walschaerts/xl8_short/right_c_rod"),
    XL_R8S_WALSCHAERTS_E_LINK = block("bogey/extra_large/walschaerts/xl8_short/right_e_link"),
    XL_R8S_WALSCHAERTS_E_ROD = block("bogey/extra_large/walschaerts/xl8_short/right_e_rod"),
    XL_R8S_WALSCHAERTS_M_ROD = block("bogey/extra_large/walschaerts/xl8_short/right_m_rod"),
    XL_R8S_WALSCHAERTS_P_ROD = block("bogey/extra_large/walschaerts/xl8_short/right_p_rod"),
    XL_R8S_WALSCHAERTS_R_BAR = block("bogey/extra_large/walschaerts/xl8_short/right_r_bar"),
    XL_R8S_WALSCHAERTS_U_LINK = block("bogey/extra_large/walschaerts/xl8_short/right_u_link"),
    XL_R8S_WALSCHAERTS_V_STEM = block("bogey/extra_large/walschaerts/xl8_short/right_v_stem"),

    XL_L8S_WALSCHAERTS_C_LEVER = block("bogey/extra_large/walschaerts/xl8_short/left_c_lever"),
    XL_L8S_WALSCHAERTS_C_ROD = block("bogey/extra_large/walschaerts/xl8_short/left_c_rod"),
    XL_L8S_WALSCHAERTS_E_LINK = block("bogey/extra_large/walschaerts/xl8_short/left_e_link"),
    XL_L8S_WALSCHAERTS_E_ROD = block("bogey/extra_large/walschaerts/xl8_short/left_e_rod"),
    XL_L8S_WALSCHAERTS_M_ROD = block("bogey/extra_large/walschaerts/xl8_short/left_m_rod"),
    XL_L8S_WALSCHAERTS_P_ROD = block("bogey/extra_large/walschaerts/xl8_short/left_p_rod"),
    XL_L8S_WALSCHAERTS_R_BAR = block("bogey/extra_large/walschaerts/xl8_short/left_r_bar"),
    XL_L8S_WALSCHAERTS_U_LINK = block("bogey/extra_large/walschaerts/xl8_short/left_u_link"),
    XL_L8S_WALSCHAERTS_V_STEM = block("bogey/extra_large/walschaerts/xl8_short/left_v_stem")
    ;
