...
import com.rabbitminers.extendedbogeys.bogeys.styles.WalschaertsBogeyRenderer.LargeDoubleAxleShortWalschaertsBogeyRenderer;
import com.rabbitminers.extendedbogeys.bogeys.styles.WalschaertsBogeyRenderer.LargeTripleAxleShortWalschaertsBogeyRenderer;
...
public class ExtendedBogeysBogeyStyles {
    ...
    public static final BogeyStyle SINGLE_AXLE_LONG_BOGEY = create("single_axle_long")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeSingleAxleLongBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle SINGLE_AXLE_PISTONLESS_BOGEY = create("single_axle_pistonless")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeSingleAxlePistonlessBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle CREATE_DOUBLE_AXLE_BOGEY = create("double_axle_scotch_yoke")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeDoubleAxleBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle DOUBLE_AXLE_LONG_BOGEY = create("double_axle_long")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeDoubleAxleLongBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle DOUBLE_AXLE_EXTRA_LONG_BOGEY = create("double_axle_extra_long")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeDoubleAxleExtraLongBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle DOUBLE_AXLE_SHORT_BOGEY = create("double_axle_short")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeDoubleAxleShortBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle DOUBLE_AXLE_PISTONLESS_BOGEY = create("double_axle_pistonless")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeDoubleAxlePistonlessBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle CREATE_TRIPLE_AXLE_BOGEY = create("triple_axle_scotch_yoke")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleAxleBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle TRIPLE_AXLE_LONG_BOGEY = create("triple_axle_long")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleAxleLongBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle TRIPLE_EXTENDED_AXLE_LONG_BOGEY = create("triple_extended_axle_long")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleExtendedAxleLongBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle TRIPLE_AXLE_SHORT_BOGEY = create("triple_axle_short")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleAxleShortBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle TRIPLE_AXLE_PISTONLESS_BOGEY = create("triple_axle_pistonless")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleAxlePistonlessBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle TRIPLE_EXTENDED_AXLE_SHORT_BOGEY = create("triple_extended_axle_short")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleExtendedAxleShortBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle TRIPLE_EXTENDED_AXLE_PISTONLESS_BOGEY = create("triple_extended_axle_pistonless")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleExtendedAxlePistonlessBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle CREATE_QUADRUPLE_AXLE_BOGEY = create("quadruple_axle_scotch_yoke")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuadrupleAxleBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle QUADRUPLE_AXLE_LONG_BOGEY = create("quadruple_axle_long")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuadrupleAxleLongBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle QUADRUPLE_AXLE_SHORT_BOGEY = create("quadruple_axle_short")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuadrupleAxleShortBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle QUADRUPLE_AXLE_PISTONLESS_BOGEY = create("quadruple_axle_pistonless")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuadrupleAxlePistonlessBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle QUINTUPLE_AXLE_LONG_BOGEY = create("quintuple_axle_long")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuintupleAxleLongBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle QUINTUPLE_AXLE_SHORT_BOGEY = create("quintuple_axle_short")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuintupleAxleShortBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle QUINTUPLE_AXLE_PISTONLESS_BOGEY = create("quintuple_axle_pistonless")
            ...
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuintupleAxlePistonlessBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
    ...
    public static final BogeyStyle WALSCHAERTS_DOUBLE_AXLE_SHORT_BOGEY = create("walschaerts_double_axle_short")
            .displayName(Components.translatable("extendedbogeys.bogeys.styles.walschaerts_double_axle_short"))
            .size(BogeySizes.LARGE, () -> LargeDoubleAxleShortWalschaertsBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.LARGE))
            .build();

    public static final BogeyStyle WALSCHAERTS_TRIPLE_AXLE_LONG_BOGEY = create("walschaerts_triple_axle_long")
            .displayName(Components.translatable("extendedbogeys.bogeys.styles.walschaerts_triple_axle_long"))
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleAxleLongWalschaertsBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();

    public static final BogeyStyle WALSCHAERTS_TRIPLE_AXLE_SHORT_BOGEY = create("walschaerts_triple_axle_short")
            .displayName(Components.translatable("extendedbogeys.bogeys.styles.walschaerts_triple_axle_short"))
            .size(BogeySizes.LARGE, () -> LargeTripleAxleShortWalschaertsBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.LARGE))
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeTripleAxleShortWalschaertsBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();

    public static final BogeyStyle WALSCHAERTS_QUADRUPLE_AXLE_SHORT_BOGEY = create("walschaerts_quadruple_axle_short")
            .displayName(Components.translatable("extendedbogeys.bogeys.styles.walschaerts_quadruple_axle_short"))
            .size(ExtendedBogeysBogeySizes.EXTRA_LARGE, () -> ExtraLargeQuadrupleAxleShortWalschaertsBogeyRenderer::new, ExtendedBogeysBlocks.STANDARD_BOGEYS.get(ExtendedBogeysBogeySize.EXTRA_LARGE))
            .build();
